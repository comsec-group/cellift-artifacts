...
furthermore depend on the Xilinx Vivado FPGA synthesis tool (version 2019.3) to reproduce
...
\begin{enumerate}
    ...
    \item \ourname is able to instrument larger designs than the competition (GLIFT), and when the resulting instrumented designs are simulated, has a lower performance overhead than the competition (GLIFT), and with a higher tainting precision.
