create_project rocket_vanilla ./rocket_vanilla -part xcvu440-flga2892-3-e
add_files {rocket_fpga_top.sv vanilla.sv}
import_files -force -norecurse
import_files -fileset constrs_1 rocket.xdc
set_property steps.synth_design.args.flatten_hierarchy full [get_runs synth_1]

set_property top rocket_fpga_top [current_fileset]
set_property top_file {rocket_vanilla.srcs/sources_1/imports/vivado_test/rocket_fpga_top.sv} [current_fileset]
