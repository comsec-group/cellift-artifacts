create_project boom_glift ./boom_glift -part xcvu440-flga2892-3-e
add_files {../boom_fpga_top_taints.sv ../glift.sv}
import_files -force -norecurse
import_files -fileset constrs_1 boom.xdc
set_property steps.synth_design.args.flatten_hierarchy full [get_runs synth_1]

set_property top boom_fpga_top [current_fileset]
set_property top_file {boom_glift.srcs/sources_1/imports/vivado_test/boom_fpga_top_taints.sv} [current_fileset]
