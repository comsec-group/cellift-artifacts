...
fig.legend(performance_handles+precision_handles, performance_labels+precision_labels, bbox_to_anchor=(0, 0, 1, 1), loc='upper center', ncol=len(performance_handles)+len(precision_handles))
...
plt.savefig('fig/ubench.png', dpi=300)
plt.savefig('fig/ubench.pdf', dpi=300)
